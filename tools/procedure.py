...
def NoiseTrain(dataset: dataloader.Loader, recommend_model, loss_class, epoch, config, w=None, flag = True):
...
def NoiseTrainAdvInfoNCE(dataset: dataloader.Loader, recommend_model, loss_class, epoch, config, w=None, adv_training_flag = False):
    Recmodel = recommend_model
    Recmodel.train()
    loss = loss_class
