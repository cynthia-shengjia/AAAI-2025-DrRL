...
LOSSES = {
    ...
    "CCL": optimizer.optim_CCL.CCLOptimizer,
    "MSE": optimizer.optim_MSE.MSEOptimizer,
    "BCE": optimizer.optim_BCE.BCEOptimizer,
}

if world.config["loss"] == "bpr" or world.config["loss"] == "BCE" or world.config["loss"] == "MSE":
...
for epoch in range(world.TRAIN_epochs):
    ...
    output_information = procedure.NoiseTrain(
        dataset = dataset, 
